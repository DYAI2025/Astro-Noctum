...
| TASK-sphx-po-report | Finaler Bericht an PO: Commit-SHAs, Deploy-SHA, Backfill-Count, Supabase-Post-Query-Resultat (`SELECT COUNT(*) FROM astro_profiles WHERE soulprint_sectors IS NULL` — soll 8 ergeben; 8 skipped/all-zero preserved), Integration-Test-Ergebnisse, Remaining Risks, Confidence. GOAL-signatur-realtime-consistency Teil-SC wird hiermit auch verifiziert. | P1 | Done | [REQ-REL-soulprint-persist-onboarding](../1-objectives/requirements/REQ-REL-soulprint-persist-onboarding.md) | TASK-sphx-integration-test | 2026-05-01 | Sprint-Abschluss. Report: `docs/sprint-S-SOULPRINT-HOTFIX-report.md` (written 2026-04-22, status flip 2026-05-01). All AC1–AC5 covered; Backfill `--apply` resolved 2026-04-19 21:10 UTC: 50 applied / 8 skipped (all-zero preserved) / 0 failed. |
