...
| TASK-ios-lockscreen-widget-spike | WidgetKit feasibility spike: research iOS Lock Screen widget constraints, data flow, effort estimate; document in docs/spikes/ | P2 | In Progress | - | - | 2026-04-10 | Descoped from TASK-ios-lockscreen-widget; output is a doc, not code |
