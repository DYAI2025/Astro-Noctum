...
| TASK-dashboard-layout-redesign | Implement Dashboard layout per approved wireframe | P1 | Done | - | TASK-dashboard-wireframe | 2026-03-29 | F1 BigFour + F2 MiniSignature Pause + F3 TagesEnergie + F4 Upgrade repositioned |
| TASK-tagesenergie-hero | Erstelle `DashboardTagesEnergie.tsx`: Hero-Sektion mit Kosmoswetter + Resonanz | P1 | Done | [REQ-F-signatur-day-night-pulse](../1-objectives/requirements/REQ-F-signatur-day-night-pulse.md) | TASK-dashboard-wireframe | 2026-03-29 | Implementiert: DashboardTagesEnergie.tsx + 37 Tests + 7 Bug-Fixes + i18n |
