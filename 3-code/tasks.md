...
| TASK-perf-trail-optimization | Optimize trail buffer size, fade rate, render batch based on benchmarks | frontend | [REQ-PERF-signatur-performance](../1-objectives/requirements/REQ-PERF-signatur-performance.md) | Todo | TASK-perf-desktop-benchmark | 2026-03-28 | iOS benchmark cancelled — web-only optimization |
