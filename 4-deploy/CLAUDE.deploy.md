...
|--------|----------|---------|
| **Web (Production)** | Railway | Production deployments via Railway |
| **Web (Staging)** | sky.bazodiac.space | VPS with nginx reverse proxy |
| **Mobile** | Expo (iOS) | iOS builds via Expo |
