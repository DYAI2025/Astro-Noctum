...
| [DEC-codebase-lives-in-sibling-prod-dir](../decisions/DEC-codebase-lives-in-sibling-prod-dir.md) | Runtime code lives in sibling `Astro-Noctum-prod/` directory | Deploy pipelines reference `Astro-Noctum-prod/` as the build context |
...
When a significant decision emerges, follow [CLAUDE.md — Decisions](../CLAUDE.md#decisions). Common triggers: secret management, environment promotion rules, rollback procedures, IaC tooling, CI/CD conventions.
