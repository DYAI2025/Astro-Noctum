...
const DIMENSIONS_EN = [
  { id: 'focus' as const, name: 'Attention Focus', poleLow: 'Self', poleHigh: 'Others' },
  { id: 'resources' as const, name: 'Resource Allocation', poleLow: 'Conserve', poleHigh: 'Give' },
  { id: 'empathy' as const, name: 'Empathic Resonance', poleLow: 'Detached', poleHigh: 'Compassionate' },
] as const;
