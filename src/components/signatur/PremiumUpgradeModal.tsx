  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label={t('signatur.premiumModal.unlockLabel')}
        tabIndex={-1}
      ...
      >
        <button
          ...
          aria-label={t('signatur.premiumModal.closeLabel')}
        >
          <X className="h-4 w-4" />
        </button>
        ...
        <p className="mb-5 text-center text-sm leading-relaxed text-white/60">
          {t('signatur.premiumModal.description')}
        </p>

        <div className="flex justify-center">
          <UpgradeButton
            label={t('signatur.premiumModal.ctaLabel')}
